package com.adinho.pdf_reader.pdf_reader.documents.generators;
...
import com.adinho.pdf_reader.pdf_reader.core.gerador_documentos.Generator;
...
public class RPVGenerator implements Generator {
    ...
    private final InputStream modelo;
    private final String numeroProcesso;
    private final List<MultipartFile> files;

    public RPVGenerator(InputStream modelo, String numeroProcesso, List<MultipartFile> files) {
        this.modelo = modelo;
